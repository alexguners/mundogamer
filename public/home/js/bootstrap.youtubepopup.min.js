...
(function ($) {
    var $YouTubeModal = null,
        ...
        $YouTubeModalFacebook = null,
        $YouTubeModalTwitter = null,
        $YouTubeModalGoogle = null,        
        id;
        margin = 5;
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if ($YouTubeModal == null) {
                ...
                var modalContent = '<div class="modal-dialog" id="YouTubeModalDialog">'+
										'<div class="modal-content" id="YouTubeModalContent">'+
                                            ...
                                            '<div class="modal-footer text-center">'+
    											...
    											'<a id="YouTubeModalFacebook" target="_blank" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>'+
                                                '<a id="YouTubeModalTwitter" target="_blank" class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>'+
                                                '<a id="YouTubeModalGoogle" target="_blank" class="btn btn-social-icon btn-google-plus"><i class="fa fa-google-plus"></i></a>'+
                                            '</di>'+
										'</div>'+
									'</div>';
                ...
                $YouTubeModalFacebook = $("#YouTubeModalFacebook");
                $YouTubeModalTwitter = $("#YouTubeModalTwitter");
                $YouTubeModalGoogle = $("#YouTubeModalGoogle");
                $YouTubeModal.modal({
                    show: false
    ...
    function setModalSocial(title, id) {
        console.log('olaaa setando href ' + title);
        $YouTubeModalFacebook.attr('href', 'https://www.facebook.com/dialog/feed?app_id=625583237494479&display=popup&caption=Video: '+title+'&link=http%3A%2F%2Fmundogamer.com.br&redirect_uri=http%3A%2F%2Fmundogamer.com.br&picture=http://mundogamer.com.br/images/noticia/capa/'+id);
        $YouTubeModalTwitter.attr('href', 'https://twitter.com/intent/tweet?text='+title+'&url=http://mundogamer.com.br');
        $YouTubeModalGoogle.attr('href', 'https://plus.google.com/share?url=http://mundogamer.com.br');
    }
    ...
    function setYouTubeTitle(youtubeId) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                setModalSocial(data.entry.title.$t,id);
            }
        });
    }
