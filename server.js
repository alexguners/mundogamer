...
var MundoGamerApp = function() {
    ...
    self.createRoutes = function() {
       ...
       //process the signup form
        ...
        self.app.get('/auth/facebook', passport.authenticate('facebook', { scope : 'email,public_profile,user_friends,user_location,user_birthday,user_activities, publish_stream' }));
